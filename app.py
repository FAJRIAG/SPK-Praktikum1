...
def index():
    ...
    return render_template(
        "index.html",
        kriteria=kriteria.to_html(index=False) if not kriteria.empty else "",
        alternatif=alternatif.to_html(index=False) if not alternatif.empty else "",
        info_kriteria=info_kriteria,
        info_alternatif=info_alternatif
    )
